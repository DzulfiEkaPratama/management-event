    ...
    <section id="daftar" class="daftar section-bg">
        ...
        <div class="container mt-5" style="border-radius: 50px 50px 5px 5px;">
            ...
            <div class="section-title" data-aos="fade-in" data-aos-delay="100">
                ...
                <h2 style="padding-top: 40px;">Daftar Event</h2>
                ...
                <div class="d-flex justify-content-center col-lg-12">
                    ...
                    <form action="" method="post" role="form" class="php-email-form mt-4 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control rounded-pill" id="name" placeholder="Nama" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="notel" class="form-control rounded-pill" id="notel" placeholder="No. Telephone" onkeypress="return onlyNumberKey(event)" required>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <h6 class="ml-3">Usia</h6>
                                <input type="number" name="usia" class="form-control rounded-pill" id="usia" placeholder="Usia" required>
                            ...
                            <div class="col-md-6 form-group">
                                ...
                                <select class="form-control rounded-pill" name="kelamin" id="kelamin" placeholeder="Jenis Kelamin" required>
                        ...
                        <div class="text-center mt-3">
                            <button type="submit" class="btn btn-primary rounded-pill w-75">Daftar</button>
                        </div>
